...
import { sendDPREmail, EMAIL_RECIPIENT_ROLES, EMAIL_RECIPIENT_ROLE_LABELS } from "../../services/dpr";
import type { EmailRecipient } from "../../services/dpr";
...
export default function EmailDPRModal({ dprId, onClose, onSent }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-white p-6 shadow-lg">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-lg font-bold">Email DPR</h2>

...
import employeeReportRoutes from "./routes/employee-report.routes.js";
import reportExportRoutes from "./routes/report-export.routes.js";
import deductionLedgerRoutes from "./routes/deduction-ledger.routes.js";
import bankAccountMasterRoutes from "./routes/bank-account-master.routes.js";
import bankDirectoryRoutes from "./routes/bank-directory.routes.js";
...
import siteBillItemRoutes from "./routes/site-bill-item.routes.js";
import siteBoqItemRoutes from "./routes/site-boq-item.routes.js";
import bankTransactionRoutes from "./routes/bank-transaction.routes.js";
import bankStatementMappingRoutes from "./routes/bank-statement-mapping.routes.js";
import bankStatementImportRoutes from "./routes/bank-statement-import.routes.js";
...
app.use("/api/v1/employee-reports", employeeReportRoutes);
app.use("/api/v1/reports", reportExportRoutes);
app.use("/api/v1/deduction-ledger", deductionLedgerRoutes);
app.use("/api/v1/bank-account-masters", bankAccountMasterRoutes);
app.use("/api/v1/bank-directory", bankDirectoryRoutes);
...
app.use("/api/v1/site-bill-items", siteBillItemRoutes);
app.use("/api/v1/site-boq-items", siteBoqItemRoutes);
app.use("/api/v1/bank-transactions", bankTransactionRoutes);
app.use("/api/v1/bank-statement-mappings", bankStatementMappingRoutes);
